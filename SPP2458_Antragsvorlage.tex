...
%DFG:
%
%  Please explain briefly and precisely the state of the art in your field in
...
%  You can cite as many publications as you want, but only if they are publically available (in the public domain, like on arXiv).
%  Up to 10 of your own publications can be hilighted as ``most important.''
...
%DFG:
%
%  If your project uses, generates and/or processes data, use this section to record key
...
%LV: Here, a smaller font size is allowed (however no smaller than 9pt)
%
%DFG:
%
